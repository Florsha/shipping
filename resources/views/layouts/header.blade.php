      ...
      <header class="header header-sticky p-0 mb-4">
        <div class="container-fluid border-bottom px-4">
          ...
          <img src="resources/assets/icons/menu.svg" alt="menu">
          </button>
          <ul class="header-nav ms-auto">
            <li class="nav-item"><a class="nav-link" href="">
                <img src="resources/assets/icons/bell.svg" alt="menu">
                </a></li>
            <li class="nav-item"><a class="nav-link" href="#">
                <img src="resources/assets/icons/list-rich.svg" alt="menu">
                </a></li>
          </ul>
          <ul class="header-nav">
            <li class="nav-item py-1">
              <div class="vr h-100 mx-2 text-body text-opacity-7 dropd5"></div>
            </li>
            <li class="nav-item dropdown">
              <button class="btn btn-link nav-link py-2 px-2 d-flex align-items-center" type="button" aria-expanded="false" data-coreui-toggle="dropdown">
                 <img src="resources/assets/icons/contrast.svg" alt="menu">
              </button>
        ...
        <div class="container-fluid px-4">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0">
              <li class="breadcrumb-item"><a href="#">Merge</a>
              </li>
              <li class="breadcrumb-item active"><span>Incoming</span>
              </li>
            </ol>
          </nav>
        </div>
